...
export function validateProject(doc,{garments,slots}){
  ...
  for(const l of doc.layers){
    ...
    for(const [key,min,max] of [['printSize',.001,100],['printAngle',0,180],['printStrength',0,100],['printMarkSize',0,100],['printTone',0,100],['printErosion',0,100]])if(l[key]!==undefined&&!finite(l[key],min,max))fail('A print texture setting is invalid.');
