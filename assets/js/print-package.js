...
import {cleanFilename} from './design-format.js?v=91-natural';
...
export async function addPrintLayouts(zip,data,plans,colorFor,{check=()=>{},message=()=>{},advance=()=>{}}={}){
  ...
  for(const [index,plan] of plans.entries()){
    check();const worker=new Worker(new URL('./print-psd-worker.js?v=91-natural',import.meta.url),{type:'module'}),layers=[];
    try{
