...
import {solidCoverageLut} from './artwork-export.js?v=65';
import {installWorkspace} from './workspace.js?v=64';
import {installExports} from './presentation-export.js?v=65';
...
function patchFabricMaterial(mat){
  ...
  mat.customProgramCacheKey=()=> 'orb-native-panel-stack-v33-uv-only';
