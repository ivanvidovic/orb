import {FORMAT_VERSION,LAYER_FIELDS,SETTING_FIELDS,pick,cleanFilename,canvasBlob,downloadBlob,validateProject} from './design-format.js?v=43';
...
export function installWorkspace(api){
  ...
  async function importImages(files){
    ...
    finally{busy=false;$('shelfDrop').innerHTML='Drop images here or <strong>browse</strong>';renderShelf();notify();}
