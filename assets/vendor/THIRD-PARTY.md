...
- Three.js 0.160.0: https://github.com/mrdoob/three/tree/r160 (MIT; `three/LICENSE`). Includes GLTFLoader, DRACOLoader, SVGLoader, and BufferGeometryUtils from the same release.
